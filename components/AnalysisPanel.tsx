...
import { FetchedData, ChatMessage, ApiConfig, AstrolabeData, VirtualFile } from '../types';
...
const AnalysisPanel: React.FC<AnalysisPanelProps> = ({ fetchedData, onConfigChange, onTriggerFetch, onCreateFile, externalInput, onInputChange, virtualFiles, messages, setMessages, astrolabe, setAstrolabe }) => {
...
`;
      ...
      while (keepGoing && turnCount < MAX_TURNS) {
        ...
        const response = await ai.models.generateContent({
          ...
          config: {
            tools: [{ functionDeclarations: [executeRequestTool, createFileTool, generateImageTool, updateAstrolabeTool] }],
      ...
      <div className="p-4 border-t border-slate-800 bg-slate-900/50 backdrop-blur-sm">
        <div className="relative">
          <textarea
            ...
            className="w-full bg-slate-800 text-slate-200 rounded-xl pl-12 pr-12 py-3 focus:outline-none focus:border-indigo-500 resize-none border border-slate-700 placeholder-slate-500 text-sm max-h-32 min-h-[50px]"
            rows={1}
